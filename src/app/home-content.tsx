...
export interface HomeContentProps {
  pageContent: Record<string, Record<string, string>> | null;
  siteStats: Record<string, Record<string, string>> | null;
}

export function HomeContent({ pageContent, siteStats }: HomeContentProps) {
